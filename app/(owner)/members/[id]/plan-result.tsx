...
export default function PlanResultScreen() {
  const { id, planId } = useLocalSearchParams<{ id: Id<'users'>, planId: Id<'aiPlans'> }>();
  ...
  if (plan === undefined) {
    return <LoadingOverlay message="Loading generated plan..." />;
  }
  ...
  return (
    <View style={styles.container}>
      <ScreenHeader title="AI Plan Result" showBack onBack={() => router.back()} />
